...
function Home() {
  ...
  return (
    userDB && <main className="flex min-h-screen w-full flex-col items-center justify-between max-w-screen" style={{ backgroundImage: `url(bg.png)`, backgroundSize: '100%', backgroundRepeat: 'no-repeat', backgroundPosition: 'right bottom', backgroundAttachment: 'fixed' }}>
