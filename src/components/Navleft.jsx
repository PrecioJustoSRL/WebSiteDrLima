        ...
        <>
            {user && <div className={`fixed right-[20px] transition-all ease-in-out duration-300 ${add ? 'bottom-[150px] lg:bottom-[73px]' : 'bottom-[-450px] lg:bottom-[73px]'} z-30`}>
                <button type="button" onClick={() => { setUserItem(undefined); funcion('Portada') }} className="h-[50px] w-[50px] my-1 text-blue-700 bg-gray-950 border border-gray-700 hover:bg-gray-500 hover:text-gray-800 focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
                    <svg className="w-6 h-6 text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <button type="button" onClick={() => { setUserItem(undefined); funcion('Servicios') }} className="h-[50px] w-[50px] my-1 bg-gray-950 border border-gray-700 hover:bg-gray-500 hover:text-gray-800 focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm text-center flex justify-center items-center p-0">
                    <svg className="w-7 h-4 mb-1 mr-0.5 text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <button type="button" onClick={() => { setUserItem(undefined); funcion('Testimonios') }} className="h-[50px] w-[50px] my-1 text-blue-700 bg-gray-950 border border-gray-700 flex- hover:bg-gray-500 hover:text-gray-800 focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
                    <svg className="w-5 h-6 ml-1 mb-1 text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div className={`fixed bottom-0 left-0 z-40 w-full h-16 bg-white border-t border-gray-200  dark:bg-gray-700 dark:border-gray-600 lg:hidden`}>
                ...
                <div className="relative grid h-full max-w-lg grid-cols-4 mx-auto font-medium z-50">
                    <a href="#" className="inline-flex flex-col items-center justify-end px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        <svg className="w-6 h-6 mb-1 text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" fill="#636363"></path>
                        </svg>
                        <span className="text-sm text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 pb-[7px] dark:group-hover:text-blue-500">Inicio</span>
                    </a>
                    <a href="#Servicios" type="button" className="inline-flex flex-col items-center justify-end px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        ...
                        <span className="text-sm text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 pt-[5px] pb-[7px] dark:group-hover:text-blue-500">Servicios</span>
                    </a>
                    <a href="#Testimonios" type="button" className="inline-flex flex-col items-center justify-end px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        ...
                        <span className="text-sm text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 pt-[6px] pb-[7px] dark:group-hover:text-blue-500">Testimonios</span>
                    </a>
                    {user ? <button className="inline-flex flex-col items-center justify-end px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" onClick={handlerAdd}>
                        ...
                        <span className="text-sm text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 pb-[7px] dark:group-hover:text-blue-500">Add</span>
                    </button>
                        : <button className="inline-flex flex-col items-center justify-end px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" onClick={handlerShare}>
                            <svg className="w-5 h-5 mb-1 text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <span className="text-sm text-gray-8000 dark:text-gray-400 group-hover:text-blue-600 pb-[7px] dark:group-hover:text-blue-500">Share</span>
                        </button>}
                </div>
            </div>
        </>
